...
\input{TexSections/INRIA}

\input{TexSections/Research-within-INRIA}

\input{TexSections/Petroleum-Exploration}

\input{TexSections/Presentation-of-the-Problem}

\input{TexSections/Discontinuous-Galerkin-Method}

\input{TexSections/Mesh-Creation}

\input{TexSections/PML-Coefficients-Automation}

\input{TexSections/Numerical-Results}

\input{TexSections/Conclusions}

\input{TexSections/Bibliography}
